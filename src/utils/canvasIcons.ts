...
/**
 * TikTok / Live Streaming Icon (Matches Image 2 - circle with musical note)
 */
export function drawTikTokLiveIcon(
  ...
  ctx.fillStyle = color;
  ctx.beginPath();
  // Note head (bottom-left circle)
  ctx.arc(9.5, 14, 2.5, 0, Math.PI * 2);
  ctx.fill();
  ...
  ctx.moveTo(11.5, 14);
  ctx.lineTo(11.5, 7.5);
  ctx.quadraticCurveTo(12.5, 9, 15.5, 9);
  ctx.stroke();
