      ...
      <div className="bg-white border-2 border-red-600 text-gray-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="bg-red-600 px-5 py-4 flex items-center justify-between text-white">
          <div className="flex items-center gap-2.5 font-extrabold text-base font-['Montserrat'] tracking-tight">
            ...
            <div>
              <h3 className="text-base font-bold leading-none">Konfirmasi Hapus Banyak Trip</h3>
              <p className="text-[11px] text-red-100 font-normal mt-0.5">
          ...
          <button
            onClick={onClose}
            disabled={isDeleting}
            className="p-1.5 hover:bg-red-700 rounded-lg transition-colors text-white/90 hover:text-white cursor-pointer disabled:opacity-50"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="bg-slate-50 px-5 py-3.5 border-t border-slate-200 flex justify-end gap-2.5">
          <button
            onClick={onClose}
            disabled={isDeleting}
            className="px-4 py-2 rounded-xl text-xs font-bold bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 transition-colors cursor-pointer disabled:opacity-50"
          >
            Batal
          </button>
          <button
